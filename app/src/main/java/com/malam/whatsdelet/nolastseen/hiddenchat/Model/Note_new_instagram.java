...
public class Note_new_instagram {
...
public Note_new_instagram() {
    }

    public Note_new_instagram(int id, String note, String number, String call_time, String image_path, String timestamp) {
        this.id = id;
        this.note = note;
