...
public class Chat_contact_Adapter_Messenger extends RecyclerView.Adapter<Chat_contact_Adapter_Messenger.MyViewHolder> {

    private Context context;
    private List<Note_new_messenger> notesList;
    public static List<Note_new_messenger> selected_msgs = new ArrayList<>();
    ...
    public Chat_contact_Adapter_Messenger(Context context, List<Note_new_messenger> notesList, int size) {
