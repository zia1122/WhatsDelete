...
import com.malam.whatsdelet.nolastseen.hiddenchat.Activities.Contact_Chat_Act_Messenger;
...
public class NotesAdapter_Messenger extends RecyclerView.Adapter<NotesAdapter_Messenger.MyViewHolder> {

    private Context context;
    public static List<Note_messenger> notesList;
    public static List<Note_messenger> notesList_new;
    public static List<Note_messenger> selected_list = new ArrayList<>();
    ...
    public NotesAdapter_Messenger(Context context, List<Note_messenger> notesList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        try {
            switch (getItemViewType(position)) {
                case AD_TYPE:
                    if (Messanger_Frag.unifiedNativeAd != null) {
                        try {
                    ...
                    builder.forUnifiedNativeAd(new UnifiedNativeAd.OnUnifiedNativeAdLoadedListener() {
                        ...
                        public void onUnifiedNativeAdLoaded(UnifiedNativeAd unifiedNativeAd) {
                            Messanger_Frag.unifiedNativeAd = unifiedNativeAd;
                            adView = (UnifiedNativeAdView) LayoutInflater.from(context).inflate(R.layout.ad_unified_row_item, null);
            ...
            final Note_messenger note = notesList.get(getRealPosition(position));
            ...
            if (!Shared.getInstance().getBooleanValueFromPreference(context.getResources().getString(R.string.long_pressd_messenger_pref), false, context)) {
            ...
            Glide.with(context).load(path + "Image-messenger_" + input + ".png")
            ...
            holder.main_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(context, Contact_Chat_Act_Messenger.class);
            ...
            holder.main_layout.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    Shared.getInstance().saveIntToPreferences(context.getResources().getString(R.string.delete_tabs_position_pref), 6, context);
                    if (Shared.getInstance().getBooleanValueFromPreference(context.getResources().getString(R.string.long_pressd_messenger_pref), false, context)) {
                        return false;
                    } else {
                        if (notesList.get(getRealPosition(holder.getAdapterPosition())).getSelected()) {
                        ...
                        MainActivity.check_selected_items();
                        Shared.getInstance().saveBooleanToPreferences(context.getResources().getString(R.string.long_pressd_messenger_pref), true, context);
                        notifyDataSetChanged();
                    }
                    return false;
                }
