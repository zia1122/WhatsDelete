...
import java.util.Set;
 ...
 public abstract class FixedFileObserverAudio {
 private final static HashMap<File, Set<FixedFileObserverAudio>> sObserverLists = new HashMap<>();
 
 private FileObserver mObserver;
 private final File mRootPath;
 private final int mMask;
 
 public FixedFileObserverAudio(String path) {this(path, FileObserver.ALL_EVENTS);}
 public FixedFileObserverAudio(String path, int mask) {
 ...
 public void startWatching() {
     synchronized (sObserverLists) {
         if (!sObserverLists.containsKey(mRootPath)) sObserverLists.put(mRootPath, new HashSet<FixedFileObserverAudio>());
         
         final Set<FixedFileObserverAudio> fixedObservers = sObserverLists.get(mRootPath);
             ...
             @Override public void onEvent(int event, String path) {
                 switch (event){
                     ...
                     case FileObserver.DELETE:
                         for (FixedFileObserverAudio fixedObserver : fixedObservers)
 ...
 public void stopWatching() {
     synchronized (sObserverLists) {
         Set<FixedFileObserverAudio> fixedObservers = sObserverLists.get(mRootPath);
