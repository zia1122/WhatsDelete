...
public class DatabaseHelper_messenger extends SQLiteOpenHelper {

    // Database Version
    private static final int DATABASE_VERSION = 1;

    // Database Name
    private static final String DATABASE_NAME = "notes_db_messenger";


    public DatabaseHelper_messenger(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // create notes table
        db.execSQL(Note_messenger.CREATE_TABLE);
    }
    ...
    public long insertNote(String table_name, String note, String number, String call_time, String date, String date_n_time_4iteration, String image_path, boolean status) {
        ...
        // insert row
        long id = db.insert(Note_messenger.TABLE_NAME, null, values);
    ...
    public Note_messenger getNote(long id) {
        ...
        // prepare note object
        Note_messenger note = new Note_messenger(
    ...
    public List<Note_messenger> getAllNotes() {
        List<Note_messenger> notes = new ArrayList<>();

        // Select All Query
        String selectQuery = "SELECT  * FROM " + Note_messenger.TABLE_NAME + " ORDER BY " +
    ...
    public int updateNote(Note_messenger note) {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        db.update(Note_messenger.TABLE_NAME, values, COLUMN_ID + "=" + note.getId(), null);
        return db.update(Note_messenger.TABLE_NAME, values, COLUMN_ID + " = ?",
    ...
    public void deleteNote(Note_messenger note) {

        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(Note_messenger.TABLE_NAME, COLUMN_ID + " = ?",
