...
public class Contact_Chat_Act_Messenger extends AppCompatActivity {
    ...
    Boolean update = false, loading_list = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Shared.getInstance().saveBooleanToPreferences(getResources().getString(R.string.long_pressd_specific_chat_pref), false, Contact_Chat_Act_Messenger.this);
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Chat_contact_Adapter_Messenger.selected_msgs.size() < 1) {
                    Toast.makeText(Contact_Chat_Act_Messenger.this, getResources().getString(R.string.please_select_atleast_one_image_delete), Toast.LENGTH_LONG).show();
                    return;
                }
                AlertDialog.Builder builder = new AlertDialog.Builder(Contact_Chat_Act_Messenger.this);
    ...
    void open_messenger() {
        try {
            Intent i = getPackageManager().getLaunchIntentForPackage("com.facebook.orca");
            startActivity(i);
        } catch (ActivityNotFoundException asd) {
            Toast.makeText(Contact_Chat_Act_Messenger.this, "Facebook Messenger not found !", Toast.LENGTH_LONG).show();
        } catch (NullPointerException ad) {
            Toast.makeText(Contact_Chat_Act_Messenger.this, "Opps Something went wrong !", Toast.LENGTH_LONG).show();
        } catch (Exception er) {
            Toast.makeText(Contact_Chat_Act_Messenger.this, "Opps Something went wrong !", Toast.LENGTH_LONG).show();
        }
        /*
        ...
        try {
            ...
            Toast.makeText(Contact_Chat_Act_Messenger.this,"Please Install Facebook Messenger", Toast.LENGTH_LONG).show();
        }*/
    }
    ...
    public class bg_task extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            mAdapter = new Chat_contact_Adapter_Messenger(Contact_Chat_Act_Messenger.this, notesList_new, ad_poistion);
            ...
            if (notesList_new.size() < 1) {
                ...
                Shared.getInstance().saveBooleanToPreferences(getResources().getString(R.string.chat_clear_messenger_pref), true, Contact_Chat_Act_Messenger.this);
                finish();
    ...
    private void loading_chat_list() {
        ...
        for (int i = notesList.size() - 1; i >= 0; i--) {
            ...
            System.out.println("Name equals== " + notesList.get(i).getNote() + " <==> " + userName.getText().toString());
    ...
    public void onBackPressed() {
        ...
        Shared.getInstance().saveBooleanToPreferences(getResources().getString(R.string.chat_clear_messenger_pref), false, Contact_Chat_Act_Messenger.this);
        Shared.getInstance().saveBooleanToPreferences(input, false, Contact_Chat_Act_Messenger.this);
        Shared.getInstance().saveBooleanToPreferences(getResources().getString(R.string.long_pressd_specific_chat_pref), false, Contact_Chat_Act_Messenger.this);
